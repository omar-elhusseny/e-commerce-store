...
const { getWishlist, addWishlist, clearWishlist, removeFromWishlist, editRequestBody } = require("../controllers/wishlist.controller");
...
router.route("/")
    .get(getWishlist)
    .post(editRequestBody, addWishlistValidation, addWishlist)
